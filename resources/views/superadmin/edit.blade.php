...
<div class="min-h-screen py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            <!-- ===========================1==========================  -->
            <!-- Isi form action agar data dapat di proses di controller superadmin.update dengan parameter produk id -->
            <form action="{{ route('superadmin.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="p-8 sm:p-10">
                @csrf
                @method('PUT')
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-8">
                    <a href="{{ route('superadmin.index') }}" class="flex-1 inline-flex items-center justify-center space-x-2 bg-gray-200 hover:bg-gray-300 text-gray-900 font-semibold py-3 rounded-lg transition duration-300">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
