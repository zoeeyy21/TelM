        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl shadow-xl overflow-hidden">
            <div class="px-6 sm:px-10 py-8 sm:py-12">
                <div class="flex items-start justify-between">
                    ...
                    <a href="{{ route('superadmin.create') }}" class="hidden sm:inline-flex items-center space-x-2 bg-white text-blue-600 hover:bg-blue-50 px-6 py-3 rounded-lg font-semibold transition duration-300 transform hover:scale-105">
                ...
                <div class="sm:hidden mt-6">
                    <a href="{{ route('superadmin.create') }}" class="block w-full bg-white text-blue-600 hover:bg-blue-50 px-6 py-3 rounded-lg font-semibold text-center transition duration-300">
                        + Tambah Produk
                    </a>
                </div>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                    ...
                    <div class="group bg-white border border-gray-200 rounded-xl hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col">
                        ...
                        <div class="p-5 flex flex-col flex-1">
                            ...
                            <div class="pt-4 border-t border-gray-100 flex gap-2">
                                <a href="{{ route('superadmin.edit', $product) }}" class="flex-1 inline-flex items-center justify-center space-x-1 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 rounded-lg transition duration-300">
                                ...
                                <form action="{{ route('superadmin.destroy', $product) }}" method="POST" class="inline-flex flex-1" onsubmit="return confirm('Hapus produk ini secara permanen?')">
                                    @csrf
                                    @method('DELETE')
        ...
        @else
            ...
            <div class="px-6 py-16 text-center">
                ...
                <a href="{{ route('superadmin.create') }}" class="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-8 py-3 rounded-lg font-semibold transition duration-300 transform hover:scale-105">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                    </svg>
